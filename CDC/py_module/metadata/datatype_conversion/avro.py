    ...
    def __init__(self, defaults: dict | None = None):
        ...
        self.source_to_avro_map = {
                                    "postgres": {
                                        ...
                                        "numeric": ["null", {"type": "bytes", "logicalType": "decimal", "precision": 9, "scale": 2}],
                                        "decimal": ["null", {"type": "bytes", "logicalType": "decimal", "precision": 9, "scale": 2}],
                                        "money": ["null", {"type": "bytes", "logicalType": "decimal", "precision": 9, "scale": 2}],
                                        "char": ["null", "string"],
                                        "varchar": ["null", "string"],
                                        "text": ["null", "string"],
                                        "uuid": ["null", "string"],
